...
export const setExtensionVersion = safeCreateAction(
  'SET_EXTENSION_VERSION',
  (extensionId: string, version: string) => ({ extensionId, version })
);

export const setExtensionEndorsed = safeCreateAction(
...
export const setInstallType = safeCreateAction(
  'SET_INSTALL_TYPE',
  (type: VortexInstallType) => type
);
